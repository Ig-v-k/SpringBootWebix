...
//
//             return "<div class='rowsNumberIndicator'>Rows shown: <b>" +
//                 rowsFrom + "-" +
//                 (filteredRowsCount < rowsTo ? filteredRowsCount : rowsTo) + "</b> | Total rows: <b>" +
...
//                 //  prevent default sa
//                 // return false;
//                 // and then send ajax req with the appropriate arguments
//             },
...
//         } catch (ex) {
//             console.error(ex);
//             util.messages.showErrorMessage("Unable to load settings.");
//         }
//     }
// }
